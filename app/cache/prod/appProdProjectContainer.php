...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/usr/projects/crud-api/app/cache/prod/annotations', false);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_8011a600974bfe548a5e80859b032bfe0a78d3ae203c7ba8157449da17d4ae5e');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_8011a600974bfe548a5e80859b032bfe0a78d3ae203c7ba8157449da17d4ae5e');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_8011a600974bfe548a5e80859b032bfe0a78d3ae203c7ba8157449da17d4ae5e');
        ...
        $d->setProxyDir('/usr/projects/crud-api/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/usr/projects/crud-api/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/usr/projects/crud-api/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/usr/projects/crud-api/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/usr/projects/crud-api/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/usr/projects/crud-api/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/usr/projects/crud-api/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/usr/projects/crud-api/app/cache/prod',
            ...
            'session.save_path' => '/usr/projects/crud-api/app/cache/prod/sessions',
            ...
            'router.resource' => '/usr/projects/crud-api/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/usr/projects/crud-api/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/usr/projects/crud-api/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/usr/projects/crud-api/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/usr/projects/crud-api/app/cache/prod/doctrine/orm/Proxies',
